...
Decided to go the red hacking, penetration tester route,
#hacking

Learning through python scripss in claude and gpt,

The Gold standard:
nmap -sV -sC 192.168.1.1
 
[[red team hacking docs
]]
* red team hacking docs 
...
Techie
    ...
    The Art of Deception: Controlling the Human Element of Security by Kevin Mitnic 
...
Top Tools Used by Red Teamers
Category 	Tools
Reconnaissance 	Nmap, Amass, Recon-ng
...
Phishing Campaigns 	Gophish, Evilginx2
Payload Delivery 	Veil, Unicorn, MSFvenom
Persistence 	Nishang, Regsvcs, DLL injection
Data Exfiltration 	DNSCat2, Rclone


Top Certifications for Red Teaming

Earning relevant certifications boosts your credibility and hands-on knowledge.

    OSCP (Offensive Security Certified Professional)

        Real-world exploit development and penetration testing

    CRTP (Certified Red Team Professional)

        Focuses on Active Directory exploitation

    CRTO (Certified Red Team Operator)

        Advanced post-exploitation and lateral movement

    CEH (Certified Ethical Hacker)

        Basic ethical hacking foundation

    eJPT, eCPTX, PNPT

        Entry and intermediate level Red Team certs
...
* SSL & TLS Handshake
source: https://www.ssl.com/article/ssl-tls-handshake-ensuring-secure-online-interactions/
source: https://www.geeksforgeeks.org/computer-networks/what-is-ssl-tls-handshake/
...
* TCP & UDP
TCP vs. UDP: The Postal Service vs. The Megaphone

Every port uses one of these two "transport" methods. In your ss output, you see both.
1. TCP (Transmission Control Protocol)

    The Concept: A reliable, back-and-forth conversation that ensures every piece of data arrives perfectly.

    Simple Analogy: Think of a Certified Letter. You send it, the recipient signs for it, and they send back a receipt. If a page is missing, you realize it immediately and send it again.

    On your list: You see sshd on Port 22 using TCP. This makes sense—if you are typing commands into a server, you need every single letter to arrive in the right order.

2. UDP (User Datagram Protocol)

    The Concept: Fast, one-way broadcasting with no guarantee of arrival.

    Simple Analogy: Think of a Megaphone or a Live TV Broadcast. The speaker shouts information out. If you blink and miss a word, they don't stop and repeat it; they just keep going. It’s "fire and forget."

    On your list: You see firefox and avahi-daemon using UDP. UDP is great for things like video calls or "finding" devices on a network where speed matters more than perfection
